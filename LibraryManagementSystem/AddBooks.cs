    ...
    public partial class AddBooks : UserControl
    {
                ...
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        using(SqlCommand cmd = new SqlCommand(insertData, connect))
                        {
                            ...
                            MessageBox.Show("Adaugare cu succes", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void addBooks_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DialogResult check = MessageBox.Show("Sunteti siguri ca doriti sa faceti UPDATE Book ID:"
                    ...
                    if(check == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Actualizare cu succes", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void addBooks_deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State != ConnectionState.Open)
                {
                    DialogResult check = MessageBox.Show("Sunteti siguri ca doriti sa faceti DELETE la Book ID:"
                        + bookID + "?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
