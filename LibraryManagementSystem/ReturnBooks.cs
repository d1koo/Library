    ...
    public partial class ReturnBooks : UserControl
    {
        ...
        private void returnBooks_returnBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DialogResult check = MessageBox.Show("Sunteti siguri ca Emitere ID: "
                        + returnBooks_issueID.Text.Trim()
                        + "este returnat?", "Confirmation Message", MessageBoxButtons.YesNo
                    ...
                    if(check == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Returnare cu succes", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
